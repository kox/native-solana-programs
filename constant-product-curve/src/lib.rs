...
// ΔX = X₁ - X₂
#[inline]
pub fn delta_x_from_y_swap_amount_with_fee(
    x: u64,
    y: u64,
    a: u64,
    fee: u16,
    ...
    let raw_amount = x
        .checked_sub(x2_from_y_swap_amount(x, y, a)?)
        .ok_or(CurveError::Overflow)?;
    let amount = raw_amount
        .checked_mul((10_000 - fee).into())
        .ok_or(CurveError::Overflow)?
...
// ΔY = Y₁ - Y₂
#[inline]
pub fn delta_y_from_x_swap_amount_with_fee(
    x: u64,
    y: u64,
    a: u64,
    fee: u16,
